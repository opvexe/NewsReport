...
@implementation NRCoreToolCenter

+ (void)load{
    
    [SVProgressHUD setBackgroundColor:NRColor(0, 0, 0, 0.8)];
...
+ (UIImage *)getThumImageFromAsset:(id)asset withSize:(CGSize)size {
    ...
    if ([asset isKindOfClass:[PHAsset class]]) {
        ...
        [NRCoreToolCenter generaImaeWithAsset:pa size:size completion:^(UIImage *result) {
