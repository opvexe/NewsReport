...
@implementation NSDate (NRCategory)
/*距离当前的时间间隔描述*/
...
/*时间戳时间日期描述*/
+(NSDate *)getNowTimestamp:(NSString *)timestamp{
    NSDateFormatter *dateFormatter = [NSDateFormatter dateFormatterWithFormat:timestamp];
